...
function GM:AddScoreboardName( ScoreBoard )
	...
	ScoreBoard:AddColumn( "Ник", nil, f, 10, nil, 4, 4 )
...
function GM:AddScoreboardKills( ScoreBoard )
	...
	ScoreBoard:AddColumn( "Убийства", 50, f, 0.5, nil, 6, 6 )
...
function GM:AddScoreboardDeaths( ScoreBoard )
	...
	ScoreBoard:AddColumn( "Смерти", 50, f, 0.5, nil, 6, 6 )
...
function GM:AddScoreboardPing( ScoreBoard )
	...
	ScoreBoard:AddColumn( "Пинг", 50, f, 0.1, nil, 6, 6 )

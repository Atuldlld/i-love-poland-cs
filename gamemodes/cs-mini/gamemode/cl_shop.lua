...
function OpenShop()
	...
	Shop.Paint = function (me,w,h)
		...
		draw.SimpleText("Магазин", "TheDefaultSettings", w / 2, h * .03, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
    ...
    Button.Paint = function (me, w, h)
        draw.SimpleText("Пистолеты", "TheDefaultSettings", w / 2, h / 2, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        surface.SetDrawColor(0, 0, 0, 170)
		surface.DrawRect(0, 0, w, h)
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
    ...
    Button2.Paint = function (me, w, h)
        draw.SimpleText("Тяжелое", "TheDefaultSettings", w / 2, h / 2, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        surface.SetDrawColor(0, 0, 0, 170)
		surface.DrawRect(0, 0, w, h)
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
    ...
    Button3.Paint = function (me, w, h)
        draw.SimpleText("Пистолеты-пулемёты", "TheDefaultSettings", w / 2, h / 2, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        surface.SetDrawColor(0, 0, 0, 170)
		surface.DrawRect(0, 0, w, h)
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
    ...
    Button4.Paint = function (me, w, h)
        draw.SimpleText("Винтовки", "TheDefaultSettings", w / 2, h / 2, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        surface.SetDrawColor(0, 0, 0, 170)
		surface.DrawRect(0, 0, w, h)
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
    ...
    Button5.Paint = function (me, w, h)
        draw.SimpleText("Экипировка", "TheDefaultSettings", w / 2, h / 2, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
        surface.SetDrawColor(0, 0, 0, 170)
		surface.DrawRect(0, 0, w, h)
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
...
function OpenT()
	...
	weapon1.Paint = function (me,w,h)
        ...
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
		draw.SimpleText("Оружия: ПИСТОЛЕТЫ", "TheDefaultSettings", w / 2, h * .03, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
...
function Open3T()
	...
	weapon3.Paint = function (me,w,h)
        ...
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
		draw.SimpleText("Оружия: Тяжелое", "TheDefaultSettings", w / 2, h * .03, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
...
function OpenT4()
	...
	weapon1.Paint = function (me,w,h)
        ...
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
		draw.SimpleText("Оружия: Пистолеты-пулемёты", "TheDefaultSettings", w / 2, h * .03, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
	local scroll = vgui.Create("DScrollPanel", weapon1)
	scroll:Dock(FILL)
...
function Open8()
	...
	weapon2.Paint = function (me,w,h)
        ...
        surface.SetDrawColor(255, 165, 0, 255)
        surface.DrawOutlinedRect(0, 0, w, h)
		draw.SimpleText("Экипировка", "TheDefaultSettings", w / 2, h * .03, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
	local scroll = vgui.Create("DScrollPanel", weapon2)
	scroll:Dock(FILL)
